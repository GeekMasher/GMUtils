...
try:
    release = pkg_resources.get_distribution('gmutils').version
except pkg_resources.DistributionNotFound:
    print('GMUtils must be installed to build the documentation.')
    sys.exit(1)
...
latex_documents = [
    (master_doc, 'GMUtils.tex', 'GMUtils Documentation',
     'GeekMasher', 'manual'),
]
...
man_pages = [
    (master_doc, 'gmutils', 'GMUtils Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GMUtils', 'GMUtils Documentation',
     author, 'GMUtils', 'One line description of project.',
     'Miscellaneous'),
]
